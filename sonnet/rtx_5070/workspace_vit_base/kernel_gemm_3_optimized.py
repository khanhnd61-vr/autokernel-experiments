...
Op type: gemm
Rank: 3 (14.6% of GPU time)
Model shape: M=197, N=2304, K=768
...
MODEL_SHAPES = {'M': 197, 'N': 2304, 'K': 768}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 197, 'N': 2304, 'K': 768}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 98, 'N': 1152, 'K': 384}),
    ("model_double", {'M': 394, 'N': 4608, 'K': 1536}),
]
