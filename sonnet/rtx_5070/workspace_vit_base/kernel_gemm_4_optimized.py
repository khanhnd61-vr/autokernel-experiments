...
Op type: gemm
Rank: 4 (13.1% of GPU time)
Model shape: M=197, N=768, K=768
...
MODEL_SHAPES = {'M': 197, 'N': 768, 'K': 768}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 197, 'N': 768, 'K': 768}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 98, 'N': 384, 'K': 384}),
    ("model_double", {'M': 394, 'N': 1536, 'K': 1536}),
]
