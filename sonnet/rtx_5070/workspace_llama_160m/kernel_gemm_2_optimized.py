...
Op type: gemm
Rank: 2 (13.7% of GPU time)
Model shape: M=512, N=2048, K=768
...
MODEL_SHAPES = {'M': 512, 'N': 2048, 'K': 768}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 2048, 'K': 768}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 256, 'N': 1024, 'K': 384}),
    ("model_double", {'M': 1024, 'N': 4096, 'K': 1536}),
]
...
def triton_gemm_kernel(
    ...
    # Hint that M, N, K are aligned to block sizes for this model's shapes
