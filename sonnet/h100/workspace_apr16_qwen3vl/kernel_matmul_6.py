...
Op type: matmul
Rank: 6 (5.3% of GPU time)
Model shape: M=512, N=4096, K=12288  (SwiGLU down_proj)
...
MODEL_SHAPES = {'M': 512, 'N': 4096, 'K': 12288}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 4096, 'K': 12288}),
    ("model_half", {'M': 256, 'N': 4096, 'K': 12288}),
    ("model_double", {'M': 1024, 'N': 4096, 'K': 12288}),
]
