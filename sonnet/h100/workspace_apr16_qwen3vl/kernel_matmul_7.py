...
Op type: matmul
Rank: 7 (4.2% of GPU time)
Model shape: M=512, N=4096, K=4096  (attn out_proj)
...
MODEL_SHAPES = {'M': 512, 'N': 4096, 'K': 4096}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 4096, 'K': 4096}),
    ("model_half", {'M': 256, 'N': 4096, 'K': 4096}),
    ("model_double", {'M': 1024, 'N': 4096, 'K': 4096}),
]
