...
Model shape: M=512, N=151936, K=4096  (lm_head: [seq, vocab] = [seq, dim] @ [dim, vocab])
...
MODEL_SHAPES = {'M': 512, 'N': 151936, 'K': 4096}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 151936, 'K': 4096}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 256, 'N': 151936, 'K': 4096}),
    ("model_double", {'M': 1024, 'N': 151936, 'K': 4096}),
]
