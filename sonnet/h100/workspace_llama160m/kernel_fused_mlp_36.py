...
MODEL_SHAPES = {'batch': 512, 'dim': 768, 'hidden': 2048}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'batch': 512, 'dim': 768, 'hidden': 2048}),
    # Also test nearby sizes for robustness
    ("model_half", {'batch': 256, 'dim': 384, 'hidden': 1024}),
    ("model_double", {'batch': 1024, 'dim': 768, 'hidden': 2048}),
]
