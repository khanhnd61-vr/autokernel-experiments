...
Op type: gemm
Rank: 5 (5.1% of GPU time)
Model shape: batch=12, M=197, N=64, K=197
...
MODEL_SHAPES = {'batch': 12, 'M': 197, 'N': 64, 'K': 197}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'batch': 12, 'M': 197, 'N': 64, 'K': 197}),
    # Also test nearby sizes for robustness
    ("model_half", {'batch': 6, 'M': 98, 'N': 32, 'K': 98}),
    ("model_double", {'batch': 24, 'M': 394, 'N': 128, 'K': 394}),
]
