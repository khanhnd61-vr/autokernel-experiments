...
Op type: fused_mlp
Rank: 4 (7.4% of GPU time)
Model shape: batch=8, dim=512, hidden=3072
...
MODEL_SHAPES = {'batch': 8, 'dim': 512, 'hidden': 3072}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'batch': 8, 'dim': 512, 'hidden': 3072}),
    # Also test nearby sizes for robustness
    ("model_half", {'batch': 4, 'dim': 256, 'hidden': 1536}),
    ("model_double", {'batch': 16, 'dim': 1024, 'hidden': 6144}),
]
