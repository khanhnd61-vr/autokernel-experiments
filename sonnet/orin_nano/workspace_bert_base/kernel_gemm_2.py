...
Op type: gemm
Rank: 2 (18.0% of GPU time)
Model shape: M=4096, N=768, K=3072
...
MODEL_SHAPES = {'M': 4096, 'N': 768, 'K': 3072}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 4096, 'N': 768, 'K': 3072}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 2048, 'N': 384, 'K': 1536}),
    ("model_double", {'M': 8192, 'N': 1536, 'K': 6144}),
]
