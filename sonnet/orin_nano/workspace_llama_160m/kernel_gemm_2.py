...
Op type: gemm
Rank: 2 (10.4% of GPU time)
Model shape: M=512, N=768, K=2048
...
MODEL_SHAPES = {'M': 512, 'N': 768, 'K': 2048}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 768, 'K': 2048}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 256, 'N': 384, 'K': 1024}),
    ("model_double", {'M': 1024, 'N': 1536, 'K': 4096}),
]
