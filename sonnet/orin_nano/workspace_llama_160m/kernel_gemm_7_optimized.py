...
Op type: gemm
Rank: 7 (3.6% of GPU time)
Model shape: M=512, N=256, K=768
...
MODEL_SHAPES = {'M': 512, 'N': 256, 'K': 768}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 512, 'N': 256, 'K': 768}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 256, 'N': 128, 'K': 384}),
    ("model_double", {'M': 1024, 'N': 512, 'K': 1536}),
]
