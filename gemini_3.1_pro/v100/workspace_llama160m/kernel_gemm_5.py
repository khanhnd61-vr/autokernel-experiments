...
Op type: gemm
Rank: 5 (6.7% of GPU time)
Model shape: M=1024, N=32000, K=768
...
MODEL_SHAPES = {'M': 1024, 'N': 32000, 'K': 768}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 1024, 'N': 32000, 'K': 768}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 512, 'N': 16000, 'K': 384}),
    ("model_double", {'M': 2048, 'N': 64000, 'K': 1536}),
]
